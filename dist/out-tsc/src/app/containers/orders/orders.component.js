...
let OrdersComponent = class OrdersComponent {
    constructor() {
        ...
        this.yearFilter = false; //indication for fliter cancel icon.
        this.selectedRows = new Map(); //key - order id | value -  true.
        this.currentPage = 1;
        this.checkBoxHeaderValues = new Map(); //key - pageNumber | value - is checked.
        this.rowPerPage = 6;
        this.currentCheckBoxHeader = false;
        this.isSummaryBarcodeDisplay = false;
        this.showFilterTr = false; //show filter tr.
        this.isFilter = false; //is filter activated.
        this.filterResult = []; //filtered items.
    }
    //fire when component is rendered or have been removed.
    set userContent(element) {
...
], OrdersComponent.prototype, "dt", void 0);
tslib_1.__decorate([
    ViewChild('barcode', { static: false })
], OrdersComponent.prototype, "userContent", null);
tslib_1.__decorate([
    Input()
], OrdersComponent.prototype, "orders", void 0);
tslib_1.__decorate([
    Output()
], OrdersComponent.prototype, "cancelEmitter", void 0);
tslib_1.__decorate([
    Input()
], OrdersComponent.prototype, "rowPerPage", void 0);
